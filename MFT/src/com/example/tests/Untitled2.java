...
public class Untitled2 {
  ...
  public void testUntitled2() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.cssSelector("a[title=\"Click here to create Yaware.TimeTracker Account\"]")).click();
    ...
    driver.findElement(By.id("registerEmail")).sendKeys("P_oskar@ukr.com");
